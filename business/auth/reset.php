...
function client_forgot_password_handle() {
    ...
    if ($errors) {
        ...
        $verify_url = app_url('quen-mat-khau/cap-nhat-mat-khau?token='.$token);
...
function client_reset_password_page() {
...
function client_reset_password_handle() {
    $errors = [];
    ...
    if ($errors) {
        set_errors($errors);
        redirect('quen-mat-khau/cap-nhat-mat-khau?token='.$token);
    } else {
