...
<div class="card card-default">
  <div class="card-header">
    <div class=" row d-flex">
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-info">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?= $products_sales['total'] ?> sản phẩm</span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-success">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Doanh thu ngày hôm nay</span>
            <span class="info-box-number"><?= priceVND($daily_sales['total']) ?></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-danger">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?= priceVND($monthly_sales['total']) ?></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-warning">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Doanh thu tổng</span>
            <span class="info-box-number"><?= priceVND($total_sales['total']) ?></span>
    ...
    <form method="get" class="form-inline ml-n2">
      ...
      <div class="form-group ml-1">
        <input class="form-control form-control-sm" type="date" name="order_date" value="<?= (!empty(input_get('order_date'))) ? input_get('order_date') : '' ?>">
      </div>
