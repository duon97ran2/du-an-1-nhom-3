  ...
  <div class="f-wrap">
    <div class="row">
      <ol class="ml-2 mt-0 breadcrumb bg-transparent breadcrumb-margin">
        ...
        <li class="breadcrumb-item active"><a href="<?= app_url('thong-tin-ca-nhan/don-hang/them-chi-tiet?id=' . input_get('id')) ?>">Thêm chi tiết</a></li>
      </ol>
    </div>
    <div class="row my-5">
      <div class="col">
          ...
          <div class="card card-default">
            <div class="card-header">
              ...
              <form method="get" class="form-inline ml-n2">
                ...
                <a href="<?= app_url('thong-tin-ca-nhan/don-hang/them-chi-tiet?id=' . input_get('id')) ?>" class="btn btn-primary btn-sm ml-1 mt-0">Bỏ lọc</a>
              </form>
            </div>
            <div class="card-body">
