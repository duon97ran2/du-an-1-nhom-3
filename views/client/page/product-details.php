        ...
        <div class="l-pd-comment">
          <div class="g-container"><input hidden="" id="id-page-comment" readonly="" value="993609">
            <div class="card st-card card-normal">
              <h2 class="card-title card-title--badge">Hỏi &amp; Đáp về iPhone 13 Pro Max<span class="badge text-white" style="background: rgb(220, 53, 69);">2796</span></h2>
              <div class="card-body">
                ...
                <div class="comment-content">
                  <div class="c-comment " id="f-comment-root">
                    <div class="c-comment-box">
                      <div class="c-comment-box__avatar">KVC</div>
                      <div class="c-comment-box__content">
                        <div class="c-comment-name">Kieu Van Chuong<div class="time">4 giờ trước</div>
                        </div>
                        <div class="c-comment-text">..........................?</div>
